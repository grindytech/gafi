...
describe('Contract', () => {
    ...
    it('base transaction fee by transfer erc20', async () => {
        ...
        console.log("create token fee: ", web3.utils.fromWei(BigNumber.from(before_balance).sub(BigNumber.from(after_balance)).toString()), "GAKI");
    }).timeout(3600000);
    ...
    it('base transaction fee by transfer erc20', async () => {
        ...
        console.log("transfer token fee: ", web3.utils.fromWei(BigNumber.from(before_balance).sub(BigNumber.from(after_balance)).toString()), "GAKI");
    }).timeout(3600000);
