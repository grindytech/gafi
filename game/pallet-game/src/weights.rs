...
impl<T: frame_system::Config> WeightInfo for GameWeightInfo<T> {
	...
	/// Storage: Game MaxSupplyOf (r:0 w:1)
	/// Proof: Game MaxSupplyOf (max_values: None, max_size: Some(45), added: 2520, mode: MaxEncodedLen)
	...
	/// Storage: Nfts CollectionRoleOf (r:1 w:0)
	/// Proof: Nfts CollectionRoleOf (max_values: None, max_size: Some(69), added: 2544, mode: MaxEncodedLen)
	/// Storage: Game MaxSupplyOf (r:1 w:1)
	/// Proof: Game MaxSupplyOf (max_values: None, max_size: Some(45), added: 2520, mode: MaxEncodedLen)
	/// Storage: Game ItemBalanceOf (r:1 w:1)
	/// Proof: Game ItemBalanceOf (max_values: None, max_size: Some(84), added: 2559, mode: MaxEncodedLen)
	/// The range of component `s` is `[0, 10]`.
	...
	/// Storage: Nfts Collection (r:1 w:0)
	/// Proof: Nfts Collection (max_values: None, max_size: Some(84), added: 2559, mode: MaxEncodedLen)
	/// Storage: Game MaxSupplyOf (r:3 w:0)
	/// Proof: Game MaxSupplyOf (max_values: None, max_size: Some(45), added: 2520, mode: MaxEncodedLen)
	/// Storage: System Account (r:1 w:1)
	/// Proof: System Account (max_values: None, max_size: Some(128), added: 2603, mode: MaxEncodedLen)
	/// Storage: Game LootTableOf (r:0 w:1)
