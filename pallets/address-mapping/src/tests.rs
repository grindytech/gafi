use crate::{mock::*, AddressMapping, Error, H160Mapping, Id32Mapping, OriginAddressMapping};
...
fn bond_should_works() {
	ExtBuilder::default().build_and_execute(|| {
		...
		assert_eq!(Id32Mapping::<Test>::get(origin_address), Some((origin_sender, RESERVATION_FEE)));
